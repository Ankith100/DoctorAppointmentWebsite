...
$host = "localhost";
$dbuser = "id20251014_ankarao_doctordb";
$dbpass = "BW^Z\)~nnj?6^22C";
$dbname = "id20251014_ankarao_doctorappointment";

$conn = new mysqli($host, $dbuser, $dbpass, $dbname);
$sql = "SELECT ID, DoctorName, DoctorInformation, DoctorImage from Doctors 
where DoctorArea like  '%".$search_area."%' and DoctorCatogery like '%".$search_param."%'";
